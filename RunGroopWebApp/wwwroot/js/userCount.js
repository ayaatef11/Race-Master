//create connection
var connectionUserCount = new signalR.HubConnectionBuilder().withUrl("/hubs/userCount", signalR.HttpTransportType.WebSockets
)//you can specify the type of the transport in the second parameter 
    .build();
