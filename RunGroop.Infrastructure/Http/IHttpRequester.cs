...
public interface IHttpRequester
{
    ...
    Task<T> PutAsync<T>(string url, object? body = null, string? bearerToken = null) where T : class;
    Task<T> DeleteAsync<T>(string url, object? body = null, string? bearerToken = null) where T : class;
}
